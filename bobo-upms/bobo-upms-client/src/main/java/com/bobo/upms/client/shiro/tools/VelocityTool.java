package com.bobo.upms.client.shiro.tools;
...
public class VelocityTool {
    ...
    private static Logger _log = LoggerFactory.getLogger(VelocityTool.class);
    ...
    public Object getPrincipalProperty(String property) {
        ...
        if (subject != null) {
            ...
            try {
                ...
                _log.trace("Property [{}] not found in principal of type [{}]", property,
                        principal.getClass().getName());
            } catch (Exception e) {
                _log.trace("Error reading property [{}] from principal of type [{}]", property,
                        principal.getClass().getName());
            }
        }
